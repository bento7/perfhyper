...
from PyQt5.QtCore import (QByteArray, QDir, QEasingCurve, QFile, QFileInfo,
        ...
        QStandardPaths, Qt, QT_VERSION, QT_VERSION_STR, QTextStream, QUrl,QRectF)
from PyQt5.QtWidgets import QGraphicsObject,QApplication, QMessageBox, QMainWindow, QPushButton, QPlainTextEdit, QVBoxLayout, QWidget
...
class MenuManager(QGraphicsObject):
